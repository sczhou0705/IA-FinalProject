...
def generate_dummy_data()
    ### Randomly generating student's names
    nr_of_students = 100
    students = []
    ...
    print("Successfully randomly generated student's names")

    ### Student's major in Katz school
    df['Katz School Major'] = np.random.choice(['Data Analytics and Visualization', 'Artificial Intelligence'], size = len(df), p = [0.7, 0.3])
    print("Successfully assigned student's major")

    ### Student's Graduation Semesters
    ...
    print("Successfully assigned student's Graduation Semesters")
    ...
    print("Successfully assigned student's Country of Origin")
    ...
    print("Successfully assigned student's language")

    ### Student's Undergraduate Majors
    ...
    print("Successfully assigned student's Undergraduate Major")
    ...
    print("Successfully assigned student's courses")
    ...
    print("Successfully assigned student's Course Semesters")
    ...
    print("Successfully generated student's ID")
    ...
    print("Successfully assigned student's GPA")
    ...
    print("Successfully assigned student's age")
    ...
    print("Successfully assigned student's Years of Experience")
    ...
    print("Successfully assigned student's Location")
    ...
    print("Successfully assigned student's Job Title")

    ### Merge courses and semesters
    ...
    print("Successfully generated student dummy data")

### Import csv file into S3 bucket
def main(event=None, context=None):
    df = pd.DataFrame(df,columns = [['Student ID',
     'First Name',
     'Last Name',
     'Katz School Major',
     'GPA',
    ...
    print("Start adding student's data to csv")
